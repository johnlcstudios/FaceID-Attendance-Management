...
const EmployeeProfile: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    emergencyContact: 'Jane Doe (09123456789)',
  });
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-blue-600 mt-1">View and update your profile information</p>
      </div>

      {showFaceScanner ? (
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-blue-900">Update Profile Photo</h2>
            <button
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-6 border-b border-blue-200">
            <div className="flex flex-col sm:flex-row items-center sm:items-start">
              <div className="mb-4 sm:mb-0 sm:mr-6">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 bg-white rounded-full p-1.5 shadow-sm border border-blue-200"
                  >
              ...
              <div>
                <h2 className="text-xl font-bold text-blue-900">{formData.name}</h2>
                <p className="text-blue-600 mb-2">{formData.email}</p>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2 border border-blue-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-blue-500">Email cannot be changed</p>
              </div>
              
              <div>
                <label htmlFor="position" className="block text-sm font-medium text-blue-700 mb-1">
                  Position
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <label htmlFor="emergencyContact" className="block text-sm font-medium text-blue-700 mb-1">
                  Emergency Contact
                </label>
                <input
                  type="text"
